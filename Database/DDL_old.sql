...
(
	...
	Birth_Date 	DATE,
	Sex 	NVARCHAR(15)  NOT NULL CHECK(Sex IN (N'Nam', N'Nữ', N'Không bắt buộc')),
	Address VARCHAR(30),
	Email 	VARCHAR(30) NOT NULL,
	Account_Type NVARCHAR(15) NOT NULL CHECK(Account_Type IN (N'Administrator', N'Teacher', N'Learner'))
);
GO
CREATE TABLE LEARNER
(
	User_ID 	CHAR(7)	PRIMARY KEY,
	Education_Degree NVARCHAR(15) NOT NULL CHECK(Education_Degree IN (N'Cử nhân', N'Thạc sĩ', N'Tiến sĩ', N'Khác')),
...
(
	User_ID 	CHAR(7)	PRIMARY KEY,
	Degree NVARCHAR(30) NOT NULL CHECK(Degree IN (N'Professor', N'Director', N'Senior preceptor', N'Assistant professor')),
...
(
	...
	Level NVARCHAR(15) CHECK(Level IN (N'Giới thiệu', N'Trung cấp', N'Nâng cao')),
...
(
	...
	Result NVARCHAR(15) NOT NULL CHECK(Result IN (N'Đạt', N'Không đạt')),
	Description	VARCHAR(255),
